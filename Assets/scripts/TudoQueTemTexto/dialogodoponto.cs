...
public class dialogodoponto : MonoBehaviour
{
    ...
    public string VaiEmbora;
    public int MeuIndice;
    ...
    void ProximaFrase()
    {
        ...
        else
        {
            ...
            if (MeuIndice == doCArlao.PessoaLugarFixo)
            {
                SceneManager.LoadScene(Voltar);
            }
            else if (!string.IsNullOrEmpty(VaiEmbora))
            {
                SceneManager.LoadScene(VaiEmbora);
            }
            else
            {
